...
<html lang="en">
<head>
    <title>Code coverage report for lib/AttributeValueUpdate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> AttributeValueUpdate.js
    </h1>
    <div class='clearfix'>
...
119
120
121</td><td class="line-coverage quiet"><span class="cline-any cline-yes">2×</span>
...
function appendAttrsKeysOnly(action, attrs, updates, opts) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (attrs &amp;&amp; isArray(attrs)) {
    for(var i = 0; i &lt; attrs.length; i++) {
      var key = attrs[i];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (key &amp;&amp; isStr(key)  &amp;&amp; key.length &gt; 0)
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof attrs === "object") {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Jul 10 2016 18:16:23 GMT+0530 (IST)
</div>
</div>
