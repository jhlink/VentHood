...
<html lang="en">
<head>
    <title>Code coverage report for lib/AttributeValue.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> AttributeValue.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">93.91% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>108/115</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var isArray = require('./util').isArray;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function _preserveArrays() {</span>
<span class="cstat-no" title="statement not covered" >  __preserveArrays = true;</span>
}
&nbsp;
...
&nbsp;
    if (test(arr, isstring))
      return 'SS';
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (test(arr, isbinary))
<span class="cstat-no" title="statement not covered" >      return 'BS';</span>
&nbsp;
    return 'L';
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeExists(type))
    return type;
}
&nbsp;
&nbsp;
...
&nbsp;
  var type = detected;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isArray(val) &amp;&amp; __preserveArrays)
<span class="cstat-no" title="statement not covered" >    type = 'L';</span>
...
function wrap1(val, opts, key) {
  ...
  case 'B': return {'B': val};
<span class="branch-1 cbranch-no" title="branch not covered" >  case 'BS': <span class="cstat-no" title="statement not covered" >return {'BS': val};</span></span>
...
var unwrapFns = {
  ...
  'SS': undefined,
  'BOOL': undefined,
  'L': <span class="fstat-no" title="function not covered" >function(val) {</span> <span class="cstat-no" title="statement not covered" >return val.map(unwrap1); </span>},
  'M': <span class="fstat-no" title="function not covered" >function (val) {</span> <span class="cstat-no" title="statement not covered" >return unwrap(val); </span>},
...
function unwrap1(dynamoData) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (keys.length !== 1)
<span class="cstat-no" title="statement not covered" >    throw new Error('Unexpected DynamoDB AttributeValue');</span>
  var typeStr = keys[0];
...
function unwrap(attrVal) {
  ...
  for (var key in attrVal) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if(attrVal.hasOwnProperty(key)) {
      var value = attrVal[key];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (value !== null &amp;&amp; typeof value !== 'undefined') 
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun Jul 10 2016 18:34:02 GMT+0530 (IST)
</div>
</div>
