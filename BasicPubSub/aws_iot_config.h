...
//===============================================================
#define AWS_IOT_MQTT_HOST "a22ll78lvjbfm1.iot.us-east-1.amazonaws.com"  // your endpoint
#define AWS_IOT_MQTT_PORT 8883    // your port
#define AWS_IOT_CLIENT_ID      "photonLights"   // your client ID
#define AWS_IOT_MY_THING_NAME "photonLights" // your thing name
#define AWS_IOT_ROOT_CA_FILENAME "root-CA.crt" // your root-CA filename
#define AWS_IOT_CERTIFICATE_FILENAME "0c4441fcbc-certificate.pem.crt" // your certificate filename
#define AWS_IOT_PRIVATE_KEY_FILENAME "0c4441fcbc-private.pem.key" // your private key filename
//===============================================================
