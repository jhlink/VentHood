...
void setup() {
    Serial.begin(9600);
    System.set(SYSTEM_CONFIG_SOFTAP_PREFIX, "USS_Enterprise");
...
void loop() {
    static unsigned long record = millis();
    static unsigned long count = 0;
    static String result = "Nominal ops";
    ...
    if (digitalRead(A2) == LOW) {
        WiFi.listen(false);
        Serial.println("Things got worse.");
    }
